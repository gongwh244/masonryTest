...
- (void)videoDecode{
    ...
    NSString *input_str = [NSString stringWithFormat:@"resource.bundle/%@",@"WeChatSight.mp4"];
    NSString *output_str = [NSString stringWithFormat:@"resource.bundle/%@",@"WeChatSight.yuv"];
